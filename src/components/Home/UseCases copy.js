const posts = [
    {
      title: 'Localización de variante',
      href: '#',
    ...
    {
      title: 'De la clínica a la variante génica',
      href: '#',
      ...
      <div className="relative bg-gray-50 px-4 pt-16 pb-20 sm:px-6 lg:px-8 lg:pt-24 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="text-center">
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Experiencias y novedades</h2>
